...
# 'class1', 'class2', 'class3', 'class4', ... "class11"
#------------------------------------------------------------------------------#
name_tmp = paste("class", 1:11, sep = '')
...
## save
save(orig.index, vmat.proj.minimal.q, file = 'data/seven_nodes_to_four_nodes_projection.Rdata')
