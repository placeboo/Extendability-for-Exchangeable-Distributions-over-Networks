...
np.savetxt("eight_node_edge_graph_arr.csv", edge_graph_arr, fmt='%i',delimiter=",")
...
#with open("eight_node_egde_node_num.csv", 'w') as myfile:
...
#print(class_name)
class_name_arr = np.array(class_name, dtype= str)
unique_class_name_arr = np.unique(class_name_arr, return_index=True)[0]
unique_class_name_arr_index = np.unique(class_name_arr, return_index=True)[1]
#np.savetxt("seven_node_unique_subgraph_name.csv", unique_class_name_arr,delimiter=",")
...
#save
with open("eight_node_unique_subgraph_name.csv", 'w') as myfile:
    for nm in unique_class_name_arr:
        myfile.write(nm + '\n')
np.savetxt("eight_node_unique_subgraph_index.csv", unique_class_name_arr_index, fmt = '%i', delimiter=",")
